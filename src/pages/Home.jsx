            ...
            <div id="dashboard" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12 space-y-8">
                ...
                <motion.section initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.5 }}>
                    <TrustSection />
                        ...
                        {/* Soporte por WhatsApp — solo en Home */}
                                                <a
                                                                            href="https://wa.me/79650799797"
                                                                            target="_blank"
                                                                            rel="noopener noreferrer"
                                                                            aria-label="Soporte por WhatsApp"
                                                                            className="group fixed z-50 flex items-center justify-center rounded-full right-4 bottom-[18px] w-[47px] h-[47px] sm:right-6 sm:bottom-6 sm:w-[50px] sm:h-[50px]"
                                                                            style={{
                                                                                background: 'rgba(37, 211, 102, 0.58)',
                                                                                opacity: 0.68,
                                                                                boxShadow: '0 5px 22px rgba(0, 0, 0, 0.25), 0 3px 14px rgba(37, 211, 102, 0.08)',
                                                                                transition: 'opacity 0.18s ease, transform 0.18s ease, background 0.18s ease'
                                                                            }}
                                                                            onMouseEnter={(e) => {
                                                                                e.currentTarget.style.opacity = '1';
                                                                                e.currentTarget.style.transform = 'translateY(-2px)';
                                                                                e.currentTarget.style.background = 'rgba(37, 211, 102, 0.85)';
                                                                            }}
                                                                            onMouseLeave={(e) => {
                                                                                e.currentTarget.style.opacity = '0.68';
                                                                                e.currentTarget.style.transform = 'translateY(0)';
                                                                                e.currentTarget.style.background = 'rgba(37, 211, 102, 0.58)';
                                                                            }}
                                                                        >
                                                                            <svg viewBox="0 0 24 24" className="mx-auto pointer-events-none" style={{ width: '26px', height: '26px' }} fill="#ffffff" aria-hidden="true">
